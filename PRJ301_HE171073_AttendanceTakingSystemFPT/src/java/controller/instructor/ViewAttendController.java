...
public class ViewAttendController extends BaseAuthenticationController {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("../view/instructor/viewattend.jsp").forward(request, response);
